...
令$\alpha = \frac{pos}{\omega_i}, \beta = \frac{k}{\omega_i}$我们可以得到：
...
欧拉公式：$e^{i\theta \cdot i} = \cos(i\theta) + i\sin(i\theta)$，$e^{-i\theta \cdot j} = \cos(j\theta) - i\sin(j\theta)$；
